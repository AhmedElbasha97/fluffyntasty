  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("${AppLocalizations.of(context).translate('login')}",style: TextStyle(color: Colors.black),),
        centerTitle: true,
        leading: IconButton(
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(padding: EdgeInsets.only(top: MediaQuery.of(context).padding.top+100)),
